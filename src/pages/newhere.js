    ...
    return (
      <Layout>
        ...
        <div className="paragraphMobile">
          <div className="subheaderHistory">Welcome to Guru Nanak Dwara</div>
          ...
          <div className="getConnected">
            Get Connected
            <img className="getConnectedImages" src={facebook} alt="facebook"/>
            <img className="getConnectedImages" src={instagram} alt="instagram"/>
            <img className="getConnectedImages" src={youtube} alt="youtube"/>
            <img className="getConnectedImages" src={twitter} alt="twitter"/>
          </div> */}
